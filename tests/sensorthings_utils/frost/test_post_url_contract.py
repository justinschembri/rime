...
def test_find_datastream_observations_url_returns_datastream_parent(monkeypatch):
    ...
    monkeypatch.setattr("sensorthings_utils.frost.get.frost_entity_lookup", fake_lookup)
...
def test_make_frost_entity_observation_endpoint_appends_once(monkeypatch):
    ...
    monkeypatch.setattr("sensorthings_utils.frost.post.check_object_existence", fake_exists)
    monkeypatch.setattr("sensorthings_utils.frost.post.general_post", fake_post)
